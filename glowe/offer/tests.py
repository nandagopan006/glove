...
class OfferTestCase(TestCase):
    ...
    def test_create_product_offer(self):
        ...
        self.assertEqual(
            OfferItem.objects.filter(apply_to="PRODUCT").count(), 1
        )
    ...
    def test_calculate_best_offer(self):
        ...
        OfferItem.objects.create(
            offer=offer1, apply_to="PRODUCT", product=self.product
        )
        ...
        OfferItem.objects.create(
            offer=offer2, apply_to="CATEGORY", category=self.category
        )

        best_offer, best_discount = get_best_offer(
            self.product, Decimal("1000.00")
        )
