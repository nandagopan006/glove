...
urlpatterns = [
    ...
    path(
        "profile/cancel-verify/",
        views.cancel_email_verification,
        name="cancel_email_verification",
    ),
    path(
    ...
    path(
        "profile/image/add/", views.add_profile_image, name="add_profile_image"
    ),
    path(
