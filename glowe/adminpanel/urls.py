...
urlpatterns = [
    ...
    path(
        ...
        views.admin_forget_password,
        name="admin_forget_password",
    ),
    path(
        "admin-otp-verification/",
        views.admin_otp_verification,
    ...
    path(
        "admin-toggle-block/<int:id>/",
        views.admin_toggle_block,
        name="admin_toggle_block",
    ),
    ...
    path(
        "admin-panel/sales-report/export/excel/",
        views.export_sales_excel,
        name="export_sales_excel",
    ),
    path(
        "admin-panel/sales-report/export/pdf/",
