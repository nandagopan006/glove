...
urlpatterns = [
    ...
    path('admin-panel/coupons/restore/<int:id>/',views.restore_coupon,name='restore_coupon'),
    path('admin-panel/coupons/permanent-delete/<int:id>/',views.permanent_delete_coupon,name='permanent_delete_coupon'),
