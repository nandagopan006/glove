...
urlpatterns = [
    ...
    path(
        "signup-otp-verify/", views.signup_otp_verify, name="signup_otp_verify"
    ),
    path(
        "signup-otp/resend/", views.signup_resend_otp, name="signup_resend_otp"
    ),
    path("forgot-password/", views.forget_password, name="forget_password"),
    path(
        "forgot-password/sent/",
        views.forget_password_link,
        name="forget_password_link",
    ),
    path(
